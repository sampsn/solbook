    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-4">
      <div className="max-w-sm w-full space-y-6">
        <div className="text-center space-y-1">
          <h1 className="text-2xl font-bold" style={{ color: 'var(--color-text-strong)' }}>Join solbook</h1>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            <label className="text-sm font-medium" style={{ color: 'var(--color-text-strong)' }}>Display name</label>
            <input
              type="text"
              value={displayName}
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium" style={{ color: 'var(--color-text-strong)' }}>Username</label>
            <div className="flex items-center bg-[var(--color-surface)] border border-[var(--color-border)] overflow-hidden focus-within:border-[var(--color-accent)]">
              ...
              <input
                ...
                className="flex-1 bg-transparent px-0 py-2 text-sm placeholder:text-[var(--color-muted)] focus:outline-none"
                style={{ color: 'var(--color-text-strong)', fontSize: '16px' }}
              />
            </div>
          </div>
