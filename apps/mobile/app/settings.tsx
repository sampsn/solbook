...
export default function SettingsScreen() {
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    sectionTitle: { fontFamily: font.regular, fontSize: 13, color: colors.accentAlt, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
    label: { fontFamily: font.regular, fontSize: 14, color: colors.textStrong },
    input: {
    ...
    username: { fontFamily: font.regular, fontSize: 15, color: colors.accentAlt },
